...
# Result location
result_location = 'C://Users//prerakmody//Desktop//RK//Re-Learning//Open-AI//OpenAI-Gym//Cartpole'
...
class CartPoleController(object):
    ...
    def action(self, obs, prev_obs=None, prev_action=None):
        ...
        if prev_obs is not None:
            prev_norm = np.linalg.norm(prev_obs)   #frobenius norm in the default case (new concept here)
